                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="add_author.php" method="post">
                                    <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">Author ID:</label></b>
                                            <div class="controls">
                                                <input type="text" id="Title" name="author_id" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <b>
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Title" name="author_name"  class="span8" required>
                                            </div>
                                        </div>
...
<?php
	...
	{
		$query = "insert into author values($_POST[author_id],'$_POST[author_name]')";
