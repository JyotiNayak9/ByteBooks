                ...
                <div class="row">
                  ...
                  <!-- <form class="form-horizontal row-fluid" action="reg_author.php" method="post">
                        ...
                        <table class="table" id = "tables">
                            ...
                            $y = $_GET['name'];
                            $sql = "select * from book where book.category= '$y'";
                            $result=$conn->query($sql);
                            $rowcount=mysqli_num_rows($result);
                            ...
                            ?>
                                    <tr>
                                      <td><a style="color:black;" href="bookdetails.php?id=<?php echo $id;?>"><?php echo $id?></a> </td>
                                      <td><a style="color:black;" href="bookdetails.php?id=<?php echo $id;?>"><?php echo $name ?></a></td>
