...
ob_start();
$query = "select * from author where author_id = $_GET[id]";
...
<?php
	if(isset($_POST['update'])){
		$query = "update author set author_name = '$_POST[author_name]',author_id = '$_POST[author_id]' where author_id = $_GET[id]";
		$query_run = mysqli_query($conn,$query);
        if($query_run){
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                ?>
                                    ...
                                    <br >
                                    <form class="form-horizontal row-fluid" action="edit_author.php?id=<?php echo $authorid ; ?>" method="post">
                                    <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">Author ID:</label></b>
                                            <div class="controls">
                                                <input type="trxt" id="Title" name="author_id" value= "<?php echo $authorid?>" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">Author Name:</label></b>
                                            <div class="controls">
                                                <input type="text" id="Title" name="author_name" value= "<?php echo $name?>" class="span8" required>
                                            </div>
                                        </div>
