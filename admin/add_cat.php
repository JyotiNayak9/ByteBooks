                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="add_cat.php" method="post">
                                    <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">Category ID:</label></b>
                                            <div class="controls">
                                                <input type="text" id="Title" name="cat_id" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <b>
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Title" name="cat_name"  class="span8" required>
                                            </div>
                                        </div>
