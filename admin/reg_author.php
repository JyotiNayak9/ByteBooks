                ...
                <div class="row">
                  ...
                  <form class="form-horizontal row-fluid" action="reg_author.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Name/ID of author" class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from author where author_id='$s' or author_name like '%$s%'";
                                        }
                                    else
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $name ?></td>
                                        ...
                                        <td><center>
                                            ...
                                            <a href="delete_author.php?id=<?php echo $authorid; ?>" class="btn btn-success">Delete</a>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
                               </tbody>
